...
import { BOOLEAN_OPTIONS, BOOLEAN_UNKNOWN_OPTIONS, SYRINGES_USED } from '../../utils/FieldOptions'
  ...
  render() {
    ...
    return (
      <ScrollView style={ AppStyles.scrollContainer }>
        ...
        <SelectOneField model={ model } name="reconstitution_multiple" options={ BOOLEAN_OPTIONS } label="Same reconstitution syringe used for multiple vials of same vaccine?" />
        <SelectOneField model={ model } name="reconstitution_different" options={ BOOLEAN_OPTIONS } label="Same reconstitution syringe used for reconstituting different vaccines?" />
        <SelectOneField model={ model } name="reconstitution_vial" options={ BOOLEAN_OPTIONS } label="Separate reconstitution syringe for each vaccine vial?" />
        <SelectOneField model={ model } name="reconstitution_syringe" options={ BOOLEAN_OPTIONS } label="Separate reconstitution syringe for each vaccination?" />

        <SelectOneField model={ model } name="reconstitution_vaccines" label="Are the vaccines and diluents used the same as those recommended by the manufacturer?" />
