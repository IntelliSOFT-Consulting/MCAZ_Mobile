  ...
  render() {
    ...
    return (
      <KeyboardAwareScrollView style={ [AppStyles.scrollContainer, AppStyles.aefiBackground] } keyboardShouldPersistTaps={'handled'}>
        { followUpField }
        <TextInputField label="Patient name/Initials:" name="patient_name" model={ model } />
        ...
        <SelectOneField label="If female" name="female_status" model={ model } options={ PREG_LAC }/>
