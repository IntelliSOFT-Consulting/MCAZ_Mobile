  ...
  render() {
    ...
    return (
      <ScrollView style={ [ AppStyles.scrollContainer, AppStyles.adrBackground ] }>
        ...
        <ReadOnlyDataRenderer label="Date of birth (DD/MM/YYYY):" name="date_of_birth" model={ model } required={ true }/>
        ...
        <ReadOnlyDataRenderer label="Date &amp; Time AEFI started (DD/MM/YYYY):" name="aefi_date" model={ model } showTime={ true }/>
        <ReadOnlyDataRenderer label="Date patient notified event to health system (DD/MM/YYYY):" name="notification_date" model={ model }/>
        ...
        <ReadOnlyDataRenderer label="If died, date of death (DD/MM/YYYY)::" name="died_date" model={ model }/>
        ...
        <ReadOnlyDataRenderer label="Date report received at district level (DD/MM/YYYY):" name="district_receive_date" model={ model }/>
        <ReadOnlyDataRenderer label="Investigation needed:" options={ BOOLEAN_OPTIONS } name="investigation_needed" model={ model }/>
        <ReadOnlyDataRenderer label="If yes, date investigation planned (DD/MM/YYYY):" name="investigation_date" model={ model }/>
        <Text>National level to complete:</Text>
        <ReadOnlyDataRenderer label="Date report received at national level (DD/MM/YYYY):" name="national_receive_date" model={ model }/>
