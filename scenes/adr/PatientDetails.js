  ...
  render() {
    ...
    return (
      <ScrollView style={ AppStyles.scrollContainer }>
        ...
        <TextInputField name="patient_name" model={ model } label="Patient Initials:" required={ true }/>
        <TextInputField name="ip_no" model={ model } label="VCT/OI/TB Number"/>
        <DateTimeInput name="date_of_birth" model={ model } label="Date of birth " required={ true }/>
        ...
        <SelectOneField name="gender" model={ model } label="Gender" options={["", "Male", "Female"]} required={ true }/>
